...
const char* clientID = "mqttx_97a3425a";      // 用戶端ID，Client ID。
const char* mqttUserName = "";  // 使用者名稱，Username。
const char* mqttPwd = "";  //  使用者密碼，Password

const char* topicToSub = "channels/1485436/subscribe/fields/field3"; //訂閱in
const char* topicToPub = "channels/1485436/publish/fields/field3"; //發佈out
